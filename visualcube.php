...
//	if (!$DEBUG) error_reporting(0);
	...
	// Otherwise render a cube
		...
		// Faces
		$U = 0; $R = 1; $F = 2; $D = 3; $L = 4; $B = 5; $N = 8; $O = 7; $T = 8;
		...
		if(array_key_exists('stage', $_REQUEST) || array_key_exists('stage', $DEFAULTS)){
			...
			if($dim == 3){
				...
				break;
                    case 'fbss_back' :
                $mask = "000000000000011011000100100100101101000111111000101101";
                break;
					case 'fb' :
				...
				break;
					case 'fb' :
				$mask = "000000000000110110000101101101101000000011011000000000";
				break;
				}
			}else if($dim == 2){
				switch($stage){
